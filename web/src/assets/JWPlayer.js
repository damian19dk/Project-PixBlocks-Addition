...
window.jwplayer = function (t) {
  ...
  var r = n(18), i = {}, o = Array.prototype, u = Object.prototype, a = Function.prototype, c = o.slice, s = o.concat,
    l = u.toString, f = u.hasOwnProperty, d = o.map, p = o.reduce, h = o.forEach, v = o.filter, g = o.every, b = o.some,
    m = o.indexOf, y = Array.isArray, w = Object.keys, j = a.bind, O = window.isFinite, k = function (t, e, n) {
      var r, o;
      if (null == t) return t;
  ...
  var o = 1e5, u = 100001, a = 100002, c = 101e3, s = 102e3, l = 200001, f = 202e3, d = 104e3, p = 203e3, h = 203640,
    v = 204e3, g = 210001, b = 21e4, m = 214e3, y = 303200, w = 303210, j = 303212, O = 303213, k = 303220, C = 303230,
    P = 306e3, x = 308e3, S = 308640, E = "cantPlayVideo", T = "badConnection", A = "cantLoadPlayer",
  ...
  var r = "buffering", i = "idle", o = "complete", u = "paused", a = "playing", c = "error", s = "loading",
    ...
    b = "doubleTap", m = "over", y = "move", w = "enter", j = "out", O = c, k = "warning", C = "adClick", P = "adPause",
    x = "adPlay", S = "adSkipped", E = "adTime", T = "autostartNotAllowed", A = o, _ = "ready", F = "seek",
    M = "beforePlay", I = "beforeComplete", L = "bufferFull", N = "displayClick", D = "playlistComplete", R = "cast",
    B = "mediaError", q = "firstFrame", V = "playAttempt", z = "playAttemptFailed", H = "seeked", Q = "setupError",
    W = "state", X = "bufferChange", U = "time", Y = "ratechange", K = "mediaType", J = "volume", Z = "mute",
    $ = "metadataCueParsed", G = "meta", tt = "levels", et = "levelsChanged", nt = "visualQuality", rt = "controls",
    it = "fullscreen", ot = "resize", ut = "playlistItem", at = "playlist", ct = "audioTracks",
    st = "audioTrackChanged", lt = "playbackRateChanged", ft = "logoClick", dt = "captionsList", pt = "captionsChanged",
    ht = "providerChanged", vt = "providerFirstFrame", gt = "userAction", bt = "instreamClick", mt = "breakpoint",
    yt = "fullscreenchange", wt = "bandwidthEstimate", jt = "float"
}, function (t, e, n) {
  "use strict";
  n.d(e, "b", (function () {
    return i
  ...
  "use strict";
  var r = n(27), i = n(5), o = n(23), u = n(0), a = n(8), c = n(36), s = Object(u.m)(r.a, Object(u.C)({name: "html5"})),
    l = s.supports;
  ...
  var r = n(31), i = n(8), o = function (t) {
    ...
    var t = "//ssl.p.jwpcdn.com/player/v/8.11.10/", e = Object(i.isFileProtocol)() ? "https:" : "";
  ...
  function u(t, e) {
    var n = e.message, u = e.code, a = r(t.get("id"), n, t.get("localization").errors.errorCode, u), c = t.get("width"),
      s = t.get("height"), l = Object(i.e)(a);
    return Object(o.d)(l, {
  ...
  function ut(t, e, n, r) {
    ...
    i.forEach((function (o) {
      "function" == typeof n[o] && "Events" !== o ? t[o] = function t(e, n, r, i, o) {
        return function () {
          var u = Array.prototype.slice.call(arguments), a = u[0], c = n._trackCallQueue || (n._trackCallQueue = []),
            s = it.test(r), l = s && u[1] && u[1]._callback, f = o.edition || at(n, o, "edition"), d = "free" === f;
          if (d) {
...
var jwDefaults = {
  ...
  "height": 270,
  "key": "XjDlPHVxI+aZoL2PxNHp6w85kKhWorLzgFY6tnDxP8xZMQNvGtXfUi9yhZA=",
  "mute": false,
  "ph": 1,
  "pid": "NxsmWX2o",
  "preload": "auto",
